import { assembleUpdater } from './tauri-updater-assembler'
...
describe('assembleUpdater', () => {
  it('works', () => {
    assembleUpdater({ appVersion: '0.0.0', pubDate: new Date('2024-03-16T10:05:30Z').toString(), assetNames: allAssets })
  })
})
