...
describe('getAssetMeta', () => {
  ...
  test.each([
    ...
    { appName, filePath: 'nsis/xxx_0.0.18_x64-setup.nsis.zip', appVersion: '0.0.18', rustTarget: 'x86_64-pc-windows-msvc', expected: { assetName: 'xxx_0.0.18_x64-setup.updater.nsis.zip', isUpdater: true, isSignature: false } },
    { appName, filePath: 'msi/xxx_0.0.18_x64_en-US.msi.zip', appVersion: '0.0.18', rustTarget: 'x86_64-pc-windows-msvc', expected: { assetName: 'xxx_0.0.18_x64_en-US.updater.msi.zip', isUpdater: true, isSignature: false } },
    { appName, filePath: 'nsis/xxx_0.0.18_x64-setup.nsis.zip.sig', appVersion: '0.0.18', rustTarget: 'x86_64-pc-windows-msvc', expected: { assetName: 'xxx_0.0.18_x64-setup.updater.nsis.zip.sig', isUpdater: false, isSignature: true } },
    { appName, filePath: 'msi/xxx_0.0.18_x64_en-US.msi.zip.sig', appVersion: '0.0.18', rustTarget: 'x86_64-pc-windows-msvc', expected: { assetName: 'xxx_0.0.18_x64_en-US.updater.msi.zip.sig', isUpdater: false, isSignature: true } },
    // Windows 32
    ...
    { appName, filePath: 'nsis/xxx_0.0.18_x86-setup.nsis.zip', appVersion: '0.0.18', rustTarget: 'i686-pc-windows-msvc', expected: { assetName: 'xxx_0.0.18_x86-setup.updater.nsis.zip', isUpdater: true, isSignature: false } },
    { appName, filePath: 'msi/xxx_0.0.18_x86_en-US.msi.zip', appVersion: '0.0.18', rustTarget: 'i686-pc-windows-msvc', expected: { assetName: 'xxx_0.0.18_x86_en-US.updater.msi.zip', isUpdater: true, isSignature: false } },
    { appName, filePath: 'nsis/xxx_0.0.18_x86-setup.nsis.zip.sig', appVersion: '0.0.18', rustTarget: 'i686-pc-windows-msvc', expected: { assetName: 'xxx_0.0.18_x86-setup.updater.nsis.zip.sig', isUpdater: false, isSignature: true } },
    { appName, filePath: 'msi/xxx_0.0.18_x86_en-US.msi.zip.sig', appVersion: '0.0.18', rustTarget: 'i686-pc-windows-msvc', expected: { assetName: 'xxx_0.0.18_x86_en-US.updater.msi.zip.sig', isUpdater: false, isSignature: true } },
    // Windows ARM64
    ...
    { appName, filePath: 'nsis/xxx_0.0.18_arm64-setup.nsis.zip', appVersion: '0.0.18', rustTarget: 'aarch64-pc-windows-msvc', expected: { assetName: 'xxx_0.0.18_arm64-setup.updater.nsis.zip', isUpdater: true, isSignature: false } },
    { appName, filePath: 'nsis/xxx_0.0.18_arm64-setup.nsis.zip.sig', appVersion: '0.0.18', rustTarget: 'aarch64-pc-windows-msvc', expected: { assetName: 'xxx_0.0.18_arm64-setup.updater.nsis.zip.sig', isUpdater: false, isSignature: true } },
